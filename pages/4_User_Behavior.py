...
with right:
    fig = px.histogram(activity, x="jumlah_review", nbins=25, color_discrete_sequence=["#27364f"])
...
st.dataframe(activity[["userid", "jumlah_review", "review_per_hari", "fake_prediction_count"]].head(100), use_container_width=True, hide_index=True)
